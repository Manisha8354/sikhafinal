        ...
        <>
            <div className="min-h-screen lg:h-[80vh] transition-all duration-700 ease-in-out shadow-lg bg-gray-100">
                ...
                <div className="container mx-auto px-4 flex flex-col md:flex-row items-start justify-center">
                    ...
                    {/* Image Section - Image will take half the screen height and match content size */}
                    <div className="md:w-1/2 flex flex-col justify-start items-center md:items-start">
                        <motion.img
                            src={img}
